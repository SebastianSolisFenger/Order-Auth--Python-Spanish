        ...
        while True:
            if i == 0:
                ...
                if email == "`":
                    mostrarPaginaPrincipal()
                    return
                if email.count("0") == 0 or email.count(".") == 0:
                ...
                if password == "0":
                    ...
                    shutDown()
                if len(password) < 5:
                    print("Por favor ingrese un password de al menos 7 caracteres")
                    continue

                break


# # chequear cuantos usuarios estan registrados
# usuarioCuenta = int()
# if len(usersFileLines) == 0:
#     usuarioCuenta = 0
# else:
#     usuarioCuenta = int(usersFileLines[0].rstrip()[5 : len(usersFileLines[0]) - 2]) + 1
...
# usersFileLines.insert(0, f"--apellido {apellido} \n")
# usersFileLines.insert(0, f"--primerNombre {primerNombre} \n")
# usersFileLines.insert(0, f"--user {usuarioCuenta} \n")
...
# print("\nAhora es tiempo de iniciar sesion")
# print("----------------------------------------\n")
